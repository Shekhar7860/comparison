...
const advert = firebase.admob().interstitial('ca-app-pub-8508945282485590/1451595541')
 ...
 setTimeout(() => {
   if (advert.isLoaded()) {
    ...
    console.log('value', dataSnapshot.val().photo)
     ...
     db.ref('/users').limitToFirst(18).once('value')
     .then((dataSnapshot) => {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container} >
       ...
       <TouchableOpacity onPress={() => this.goBack()}>
                    ...
                    <Text style={styles.toolbarTitle}> Modicare Products Comparison</Text>
       ...
       {this.state.items !== [] ?
        ...
        >
          <Image
            ...
            style={{ width: 320, height: 320, alignSelf:'center', marginTop:20 }}
          />
          {/* <Card
    ...
    size={"SMALL_BANNER"}
  unitId={"ca-app-pub-8508945282485590/7395500448"}
